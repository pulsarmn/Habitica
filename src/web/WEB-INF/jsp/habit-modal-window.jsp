...
<div class="modal-overlay active" id="edit-entity-modal">
    <div class="modal-content">
        <div class="modal-header">
            <h2><fmt:message key="home.edit.habit.header" bundle="${labels}"/></h2>
        ...
        <div class="modal-footer">
            <button class="delete-entity"><fmt:message key="home.habit.delete.button" bundle="${labels}"/></button>
            <button class="reset-habit"><fmt:message key="home.habit.reset.button" bundle="${labels}"/></button>
        </div>
    </div>
</div>
