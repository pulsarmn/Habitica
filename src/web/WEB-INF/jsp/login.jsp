...
<div class="form-wrapper">
    ...
    <form id="login-form" method="post">
        <div class="text-center">
            <div class="svg-icon habitica-logo">
        ...
        <div class="form-group">
            <label for="usernameId">Электронный адрес или имя пользователя (с учетом регистра)</label>
            <input type="text" id="usernameId" placeholder="Электронный адрес или имя пользователя (с учетом регистра)">
        </div>
        <div class="form-group">
            <label for="passwordId">Пароль</label>
            <a href=""></a>
            <input type="text" id="passwordId" placeholder="Пароль">
        </div>
        <div class="text-center">
